...
func TestSanitizeOAuthModelAlias_PreservesOptionalFields(t *testing.T) {
	cfg := &Config{
		OAuthModelAlias: map[string][]OAuthModelAlias{
			" CoDeX ": {
				{Name: " gpt-5 ", Alias: " g5 ", Fork: true, DisplayName: " GPT Five ", MaxContextLength: 947369, SourceMaxContextLength: 372000, ForceMapping: true},
				{Name: "gpt-6", Alias: "g6"},
			},
		},
	}
	...
	if aliases[0].Name != "gpt-5" || aliases[0].Alias != "g5" || !aliases[0].Fork || aliases[0].DisplayName != "GPT Five" || aliases[0].MaxContextLength != 947369 || aliases[0].SourceMaxContextLength != 372000 || !aliases[0].ForceMapping {
